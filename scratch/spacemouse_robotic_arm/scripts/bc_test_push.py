...
def evaluate_and_view_policy(policy, num_episodes=3):
    ...
    eval_raw = gym.make("FrankaPushSparse-v0", render_mode="human", max_episode_steps = 350)
...
def train_on_operator_data(data_path="operator_data_push.pkl"):
    # 1. Instantiate wrapped environment matching data dimensionality
    raw_env = gym.make("FrankaPushSparse-v0")
